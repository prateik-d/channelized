...
use App\Industry;
use App\Vendor;
use App\Type_of_technical_education;
...
class TechnicalEducationController extends Controller
{
    /**
    ...
    {
        $events = Auth::user()->getUserEvents('technical_education')->get();
        ...
        return view('vendor.technical_education', compact('events','ecounts'));
    }
    ...
    public function create($etype = 'multiple')
    {
        ...
        $vendors = Vendor::get();
        $type_of_events = Type_of_technical_education::get();
        return view('technical_education.create', compact('etype','cities', 'states', 'solutions', 'industries', 'vendors','type_of_events'));
    }
    ...
    public function store(Request $request)
    {
        if($request->status!="draft"){
            $this->validate($request, [
                'name' => 'required|unique:events,name,NULL,id,category,technical_education,is_deleted,0',
                'location.*' => 'required',
        ...
        $fields = [
            ...
            'type_of_technical_education_id' => $data['type'],
            'logo' =>  $logo,
            'banner' =>  $banner,
        ...
        return redirect(Auth::user()->roles[0]->name.'/event_success/technical_education');
    }
    ...
    public function edit($id)
    {
       ...
       return view('technical_education.edit', compact('event', 'cities', 'states', 'solutions', 'industries', 'vendors','type_of_events'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->status!="draft"){
            $this->validate($request, [
                'name' => 'required|unique:events,name,'.$id.',id,category,technical_education,is_deleted,0',
                'location.*' => 'required',
    ...
    //            'tz' => 'required',
        ...
        if(!isset($data['category'])){
            $data['category'] = 'technical_education';
        }
        ...
        return redirect(Auth::user()->roles[0]->name.'/technical-education')->with('success','event updated successfully.');
    }
    ...
    public function partner_technical_education(Request $request){
        ...
        $industries = Industry::get();
        $vendors = Vendor::get();
        $type_of_technical_educations = Type_of_technical_education::get();
        ...
        if($request->search_event){
            ...
            $events = Helper::get_filtered_events($partner_filter,'technical_education');
            $filter_events_count = $events->count();
           /*  $qu = DB::getQueryLog();
            print_r($qu);
            exit(); */
        }else{
            $events = Helper::get_active_technical_education();
        }
       ...
       /*  echo '<pre>'; */
        ...
        exit; */
        return view('technical_education.partner', compact('cities','states','solutions','industries','vendors','type_of_technical_educations','partner_filter','events','txt','filter_events_count'));
    }
    ...
    public function partner_filter_store(Request $request){
        ...
        $this->validate($request, [
            'city' => 'required_without_all:state,solution,industry,vendor,type_of_technical_education,month',
            'state' => 'required_without_all:city,solution,industry,vendor,type_of_technical_education,month',
            'solution' => 'required_without_all:state,city,industry,vendor,type_of_technical_education,month',
            'industry' => 'required_without_all:state,solution,city,vendor,type_of_technical_education,month',
            'vendor' => 'required_without_all:state,solution,industry,city,type_of_technical_education,month',
            'type_of_technical_education' => 'required_without_all:state,solution,industry,vendor,city,month',
            'month' => 'required_without_all:state,solution,industry,vendor,city,type_of_technical_education'
        ]);
        ...
        if(isset($data['type_of_technical_education'])){
            $fields['type_of_technical_education_id'] = $data['type_of_technical_education'];
        }
        if(isset($data['month'])){
        ...
        $fields['category'] = 'technical_education';

        $partner_filter = PartnerFilter::updateOrCreate(['user_id'=>Auth::user()->id,'category'=>'technical_education'],$fields);
    ...
    public function partner_technical_education_filter(Request $request){
        /* echo '<pre>';
        print_r($request->all());
        exit(); */
        ...
        if(isset($data['filter']['type_of_technical_education'])){
            $partner_filter->type_of_technical_education_id = $data['filter']['type_of_technical_education'];
        }
        ...
        if(isset($partner_filter->type_of_technical_education_id) && $partner_filter->type_of_technical_education_id != 0){
            $search_parameter['type_of_technical_education'] = Type_of_technical_education::find($partner_filter->type_of_technical_education_id)->name;
        }
    ...
    public function admin_technical_education_edit($id)
    {
        $id = Crypt::decrypt($id);
        $event = Event::find($id);
        $cities = City::get();
    ...
    public function admin_technical_education(){
        $events = Event::where('is_deleted',0)->where('category','technical_education')->get();
        return view('admin.technical_education', compact('events'));
    }

    public function partner_technical_education_calender(){
        //$events = Auth::user()->getUserEventShortlist;
        $events = Helper::get_shortlisted_events('technical_education');
        return view('technical_education.partner_calender', compact('events'));
    }
}
