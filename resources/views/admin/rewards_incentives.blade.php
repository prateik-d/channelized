                ...
                <tbody>
                    @foreach($events as $event)
                        <tr> 
                            ...
                            <td>
                                @if($event->category == 'reward_incentive')
                                <a href="{{route(Auth::user()->roles[0]->name.'.rewards-incentives.edit',Crypt::encrypt($event->id))}}" class="btn btn-sm btn-info">Edit</a>
                                @endif
                                @if($event->category == 'technical_education')
                                <a href="{{route(Auth::user()->roles[0]->name.'.technical-education.edit',Crypt::encrypt($event->id))}}" class="btn btn-sm btn-info">Edit</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
