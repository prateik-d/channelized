...
<div class="admin-container">
    ...
    @endif
    <form method="POST" id="event_add" class="event-add-form" action="{{ route(Auth::user()->roles[0]->name.'.events.store') }}" enctype='multipart/form-data'>
        @csrf
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="create-event-form-input evdate">
                                            <input  type="date" class="flatpickr-input @error('stdt') is-invalid @enderror" name="stdt" required="" autocomplete="stdt" placeholder="dd/mm/yyyy" autofocus>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="create-event-form-input evdate">
                                            <input id="etdt" type="date" class="flatpickr-input @error('etdt') is-invalid @enderror" name="etdt" required autocomplete="etdt" placeholder="dd/mm/yyyy" autofocus>
                                            @error('etdt')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
        ...
        <div class="col-md-8 mt-4 mb-5">
            <div class="event-subsv-btn">
                ...
                <button type="button" id="submit_btn" class="btn btn-primary btn-shadow event-sabbtn">Submit my event for review</button>
