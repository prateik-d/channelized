...
<div class="admin-container">
    <div class="create-event-header">
        ...
        @if(Auth::user()->roles[0]->name != "admin")
            <div class="create-event-action">
                <a href="{{route(Auth::user()->roles[0]->name.'.events.index')}}" class="btn btn-light btn-shadow">
                    Current event
                </a>
                <a href="{{route(Auth::user()->roles[0]->name.'.events.create')}}" class="btn btn-light btn-shadow">
                    + Create event
                </a>
    ...
    @endif
    <form method="POST" id="event_update" class="event-add-form" action="{{ route(Auth::user()->roles[0]->name.'.events.update',Crypt::encrypt($event->id)) }}"  enctype='multipart/form-data'>
        ...
        <div class="col-md-8">
            <div class="create-form">
                <div class="create-event-form">
                    <div class="create-event-form-row">
                        <div for="name" class="create-event-form-label">Event title</div>
                        <div class="create-event-form-input">
                        ...
                        <div class="create-event-form-input">
                            <div class="create-event-form-input">
                                <select class="event-dropcreate @error('type') is-invalid @enderror" id="type" name="type" required="">
                                    <option value="0" {{(@old('type',$event->type)==NULL ? 'selected':'')}}>Select</option>
                                    @foreach($type_of_events as $single)
                                        <option value="{{$single->id}}" {{(@old('type',$event->type)==$single->id ? 'selected':'')}}>{{$single->name}}</option>
                                    @endforeach
                                </select>
                                @error('type')
                                    <span class="invalid-feedback" role="alert">
        ...
        <div class="col-md-8">
            <div class="create-form">
                <div class="create-event-form">
                    <div class="create-event-form-row">
                        <div class="create-event-form-label">Event summary</div>
                        <div class="create-event-form-input">
