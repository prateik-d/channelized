...
<div class="admin-container">
    ...
    @endif
    <form method="POST" id="event_add" class="event-add-form" action="{{ route(Auth::user()->roles[0]->name.'.offers.store') }}" enctype='multipart/form-data'>
        @csrf
        ...
        <div class="col-md-8">
            <div class="create-form">
                <div class="create-event-form">
                    ...
                    <div class="create-event-form-row">
                        <div class="create-event-form-label">Select Product Promotions & Offers solution topic</div>
                        <div class="create-event-form-input">
                            <div class="create-event-form-input">
            ...
            <div class="create-form">
                <div class="create-event-form">
                    <div class="create-event-form-row">
                        ...
                        <div class="create-event-form-input">
                            <textarea rows="10" class="@error('summary') is-invalid @enderror" id="summary" name="summary" placeholder="Short description of your Product Promotions & Offers (not more than 350 words)" required>{{old('summary')}}</textarea>
                            @error('summary')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="create-event-form-row">
                        ...
                        <div class="create-event-form-input">
                            <textarea rows="5" class="@error('short_summary') is-invalid @enderror" id="short_summary" name="short_summary" placeholder="Short Description of your Product Promotions & Offers (not more than 150 words)" required>{{old('short_summary')}}</textarea>
                            @error('short_summary')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
        ...
        <div class="col-md-8 event-filepad">
            <div class="create-form">
                <div class="create-event-form">
                    <div class="create-event-form-row">
                        <div class="create-event-form-label">Product Promotions & Offers image:</div>
                        <div class="row">
                            <div class="col-md-6">
