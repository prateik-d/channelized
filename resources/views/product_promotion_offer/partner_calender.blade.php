...
@section('content')
    <div class="my-celender event-search-result">
        <div class="event-search-result-header">
            <h1>
                Hello {{ Auth::user()->firstname }}, don’t miss your next Product Promotions & Offers!
            </h1>
            <div class="event-search-result-action">
                <a href="{{ route(Auth::user()->roles[0]->name.'.product-promotions-offers') }}" class="btn btn-light btn-shadow">
                    Search Product Promotions & Offers
                </a>
                <a href="{{ route(Auth::user()->roles[0]->name.'.product-promotions-offers.calender') }}" class="btn btn-primary btn-shadow">
                    My Calendar
                </a>
            </div>
        </div>
        <div class="event-search-result-container">    
            ...
            <div class="upcomingEvent">
                ...
                <div class="upcomingEvent-title">
                  Your upcoming Product Promotions & Offers:
                </div>
                @php
                    $cal_data = [];
                @endphp
