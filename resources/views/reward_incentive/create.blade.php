...
<div class="admin-container">
    <div class="create-event-header">
        ...
        <div class="create-event-action">
            <a href="{{route(Auth::user()->roles[0]->name.'.rewards-incentives.index')}}" class="btn btn-light btn-shadow">
                Current Rewards & Incentives
            </a>
            <a href="{{route(Auth::user()->roles[0]->name.'.rewards-incentives.create')}}" class="btn btn-light btn-shadow">
            ...
            <div class="dropdown-menu creat-box" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="{{route(Auth::user()->roles[0]->name.'.rewards-incentives.create','single')}}">Single Rewards & Incentives </a>
                <a class="dropdown-item" href="{{route(Auth::user()->roles[0]->name.'.rewards-incentives.create','multiple')}}">One Rewards & Incentives - multiple cities</a>
            </div> --}}
        </div>
    </div>
    <!-- @if (count($errors) > 0)
    ...
    @endif
    <form method="POST" id="event_add" class="event-add-form" action="{{ route(Auth::user()->roles[0]->name.'.rewards-incentives.store') }}" enctype='multipart/form-data'>
        @csrf
            ...
            <div class="create-form">
                <div class="create-event-form">
                    <div class="create-event-form-row">
                        <div for="name" class="create-event-form-label">Rewards & Incentives title</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="create-event-form-input evdate">
                                            <input id="etdt" type="date" class="flatpickr-input @error('etdt') is-invalid @enderror" name="etdt" value="{{ old('etdt') }}" required autocomplete="etdt" placeholder="dd/mm/yyyy" autofocus>
                                            @error('etdt')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                    ...
                    <div class="create-event-form-row">
                        <div class="create-event-form-label">Select event solution topic</div>
                        <div class="create-event-form-input">
                            <div class="create-event-form-input">
                    ...
                    <div class="create-event-form-row">
                        <div class="create-event-form-label">Rewards & Incentives type</div>
                        <div class="create-event-form-input">
                            <div class="create-event-form-input">
        ...
        <div class="col-md-8">
            <div class="create-form">
                <div class="create-event-form">
                    <div class="create-event-form-row">
                        <div class="create-event-form-label">Rewards & Incentives Description</div>
                        <div class="create-event-form-input">
                            <textarea rows="10" class="@error('summary') is-invalid @enderror" id="summary" name="summary" placeholder="Description of your Rewards & Incentives (not more than 350 words)" required>{{old('summary')}}</textarea>
                            @error('summary')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="create-event-form-row">
                        <div class="create-event-form-label">Rewards & Incentives Short Description</div>
                        <div class="create-event-form-input">
                            <textarea rows="5" class="@error('short_summary') is-invalid @enderror" id="short_summary" name="short_summary" placeholder="Short Description of your Rewards & Incentives (not more than 150 words)" required>{{old('summary')}}</textarea>
                            @error('short_summary')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
    ...
    $(function () {
        ...
        $(document).on('click','.add_location', function(){
            var fields = '<div class="create-location-form-input mt-2">'+
                                ...
                                //     '<div class="col-md-4">'+
                                //         '<div class="create-event-form-input">'+
                                //             '<select class="event-dropcreate" name="city[]" required>'+
                                ...
                                //     '<div class="col-md-4">'+
                                //         '<div class="create-event-form-input">'+
                                //             '<select class="event-dropcreate" name="state[]" required>'+
