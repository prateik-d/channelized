...
<div class="admin-container  table-full">
    <div class="event-search-result">
        <div class="event-search-result-header tableevent-name">
            <h1>
                Hello {{ Auth::user()->firstname }},here is your event activities summary:
            </h1>
                        ...
                        <tbody>
                            ...
                            @foreach($events as $event)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route(Auth::user()->roles[0]->name.'.events.edit',Crypt::encrypt($event->id))}}" class="table-ico"><img src="{{ asset('public/assets/images/edite.jpg') }}" /></a>
                                        ...
                                        <a href="{{route(Auth::user()->roles[0]->name.'.events.edit',Crypt::encrypt($event->id))}}" class="table-ico"> <img src="{{ asset('public/assets/images/eyes-icon.png') }}" /></a>
                                    </td>
                                </tr>
                            @php $i++; @endphp
                            @endforeach
                    ...
                    <tbody>
                        ...
                        @foreach($ecounts as $count)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route(Auth::user()->roles[0]->name.'.events.edit',Crypt::encrypt($count->eid))}}" class="table-ico"><img src="{{ asset('public/assets/images/edite.jpg') }}" /></a>
