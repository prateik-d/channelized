...
<div class="admin-container  table-full">
    <div class="event-search-result">
        <div class="event-search-result-header tableevent-name">
            <h1>
                Hello {{ Auth::user()->firstname }},here is your Rewards & Incentives activities summary:
            </h1>
    ...
    <div class="card-list scrollbar" id="scrollbar-custombox">
        <div class="accordions-panel">
            <button class="accordions">
                ...
                <span>Your Rewards & Incentives status</span>
            </button>
            <div class="panel">
                        ...
                        <tbody>
                            ...
                            @foreach($events as $event)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route(Auth::user()->roles[0]->name.'.rewards-incentives.edit',Crypt::encrypt($event->id))}}" class="table-ico"><img src="{{ asset('public/assets/images/edite.jpg') }}" /></a>
                                        ...
                                        <a href="{{route(Auth::user()->roles[0]->name.'.rewards-incentives.edit',Crypt::encrypt($event->id))}}" class="table-ico"> <img src="{{ asset('public/assets/images/eyes-icon.png') }}" /></a>
                                    </td>
                                </tr>
                            @php $i++; @endphp
                            @endforeach
        ...
        <div class="white-table">
            <div class="top-tablebar">
                ...
                <span>Current Rewards & Incentives</span>
            </div>
            <div class="curr-rvnt-table current-arrow">
                <table id="currenevent-table" class="table current-table" style="width:100%">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Rewards & Incentives ID</th>
                            <th>Rewards & Incentives Name</th>
                            <th class="cur">Start date</th>
                            <th>End date</th>
                            <th>Rewards & Incentives performance</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @foreach($ecounts as $count)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route(Auth::user()->roles[0]->name.'.rewards-incentives.edit',Crypt::encrypt($count->eid))}}" class="table-ico"><img src="{{ asset('public/assets/images/edite.jpg') }}" /></a>
