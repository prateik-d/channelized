    ...
    <div class="col-md-12">
        ...
        <form action="{{ action('PageTemplateController@vendor_added') }}" method="POST" class="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control ckeditor" id="page_desc" name="page_desc" placeholder="Enter Page Description" required="true">{{ $templateData->page_desc }}</textarea>
            </div>
